...
category_examples = {
    ...
    "GENERAL_CHECKLIST": [
        ...
        {"note": "Carry-on packing list: passport, boarding passes, travel-size toiletries, compression socks, noise-canceling headphones, universal adapters, and medication pouch."},
        {"note": "Finals study prep: review calculus formulas, rewrite lab notes, schedule group study session, print cheat-proof summaries, and back up flashcards."},
        {"note": "Home office reset checklist: wipe monitors, dust keyboard, bundle loose cables, archive old documents, shred sensitive papers, and empty recycling."},
        {"note": "Spring garden prep tasks: sharpen pruners, start tomato seedlings indoors, refresh mulch, calibrate irrigation timers, and clean rain barrels."},
        {"note": "Road trip vehicle checklist: top off oil, check tire pressure including spare, update insurance card, download offline maps, and pack emergency kit."},
        {"note": "Thesis defense preparation: confirm committee availability, rehearse slides, print handouts, update bibliography, and test remote clicker."},
        {"note": "Guest room readiness: wash linens, replace pillows, set out towels, stock toiletry basket, and program spare key for visitors."},
        {"note": "Studio session checklist: charge camera batteries, format SD cards, pack light stands, load backdrop clamps, and sync timecodes on gear."},
        {"note": "Saturday errands game plan: drop packages at post office, pick up library holds, return borrowed tools, recycle electronics, and refill pantry jars at co-op."},
        {"note": "Pre-interview prep: review company values, gather portfolio pieces, prepare STAR stories, verify video conferencing link, and set quiet background."},
        {"note": "Morning routine checklist: hydrate, journal five lines, stretch for ten minutes, review top three priorities, and prep balanced breakfast."},
        {"note": "Rental inspection tasks: document appliance serial numbers, test smoke alarms, photograph minor scuffs, note window screen tears, and email landlord summary."},
        {"note": "Community workshop setup: arrange chairs in semi-circle, test projector and speakers, lay out name tags, prep sign-in sheet, and set refreshment table."},
        {"note": "Moving day essentials box: tool kit, toilet paper, cleaning wipes, shower curtain, overnight clothes, chargers, pet food, and important documents."},
        {"note": "Volunteer event checklist: confirm headcount, print waiver forms, pack first-aid kit, label donation bins, assign task leads, and schedule cleanup crew."},
        {"note": "Basement flood prevention: test sump pump float, clear floor drain, elevate storage boxes, review insurance contact, and photograph current condition."},
        {"note": "Semester course launch: publish syllabus online, open discussion board, schedule office hours, sync gradebook columns, and verify accessibility captions."},
        {"note": "Cooking class staging: sanitize countertops, set mise en place trays, portion spices, preheat ovens, print recipe cards, and fill dishwashing station."},
        {"note": "Podcast recording checklist: silence phone notifications, check microphone gain, confirm backup recorder, align show outline, and prep guest release form."},
        {"note": "Airbnb turnover tasks: strip beds, launder linens, reset smart lock code, restock coffee bar, update welcome guide, and photograph staging."},
        {"note": "Family camping prep: inventory tent stakes, seam-seal rainfly, pre-cook chili base, restock first-aid kit, label water jugs, and print trail permits."},
        {"note": "Client onboarding checklist: send welcome packet, provision project management board, schedule kickoff call, request brand assets, and share invoicing portal."},
        {"note": "Holiday hosting prep: polish serving ware, draft seating chart, assemble centerpiece, prepare make-ahead appetizers, and chill beverage selection."},
        {"note": "Monthly budgeting routine: download bank statements, categorize expenses, reconcile shared wallet, update savings targets, and review upcoming renewals."},
        {"note": "Garden party setup: sweep patio, string bistro lights, stage buffet table, fill beverage dispenser, set out citronella candles, and queue playlist."},
        {"note": "Quarterly data backup: clone workstation drive, upload photo archives to cloud, verify checksum logs, rotate off-site hard drive, and document process."},
        {"note": "Pre-surgery checklist: confirm arrival time, arrange caregiver ride, pre-fill prescriptions, pack loose clothing, fast after midnight, and complete paperwork."},
        {"note": "Language exam preparation: schedule oral practice with tutor, review idiom list, time mock essays, refresh grammar drills, and organize flashcard decks."},
        {"note": "Workshop facilitation prep: confirm materials shipped, print agenda copies, set up breakout assignments, load slideshow, and prep icebreaker prompts."},
        {"note": "RV departure checklist: retract awning, secure cabinets, switch fridge to propane, disconnect hookups, test brake lights, and lock storage bays."},
        {"note": "Career fair readiness: update resume stack, print business cards, prep elevator pitch, research attending companies, and pack portable charger."},
        {"note": "Studio apartment deep clean: declutter surfaces, vacuum baseboards, steam mop floors, descale showerhead, wash windows, and sanitize remotes."},
        {"note": "Remote onboarding tasks: complete HR paperwork, enroll in benefits, set up MFA, join team chat channels, schedule meet-and-greet calls, and review roadmap."},
        {"note": "Weekly content calendar checklist: brainstorm topics, assign authors, source reference links, draft social copy, schedule posts, and set analytics reminders."},
        {"note": "Exam invigilation prep: charge tablets, print attendance rosters, review accommodation list, set up spare calculators, and test clock visibility."},
        {"note": "Emergency go-bag inventory: copy IDs, include cash, pack flashlights, add battery bank, stock shelf-stable snacks, rotate water bottles, and check pet supplies."},
        {"note": "New hire IT setup: issue laptop, install security patches, create email alias, grant repository access, configure VPN profile, and share onboarding wiki."},
        {"note": "Monthly plant care: rotate pots for even light, prune dead leaves, flush accumulated salts, check moisture meters, and log fertilizer schedule."},
        {"note": "Bridal shower coordination: finalize guest count, confirm menu with caterer, assemble favor bags, script toast notes, and assign cleanup roles."},
        {"note": "Conference travel prep: register for sessions, print QR badges, schedule airport rides, pack swag table signage, update out-of-office reply, and notify clients."},
        {"note": "Classroom start-of-term checklist: label cubbies, inventory art supplies, prepare emergency contacts binder, decorate bulletin board, and test smartboard."},
        {"note": "Home energy audit tasks: replace weatherstripping, install programmable thermostat schedule, check attic insulation depth, seal fireplace damper, and log utility usage."},
        {"note": "Maker fair booth prep: cut vinyl signage, test soldering irons, charge demo laptops, laminate pricing sheets, pack extension cords, and update QR payment links."},
        {"note": "Backcountry hike planning: submit trail permit, check avalanche forecast, pack bear canister, arrange shuttle pickup, print topo map, and calibrate GPS watch."},
        {"note": "Apartment sublet handoff: document utility account numbers, draft pet care instructions, label pantry staples, list building contacts, and scan lease addendum."},
        {"note": "Music recital checklist: tune instruments, print program order, set up stage chairs, prep recording device, arrange flowers, and brief ushers."},
        {"note": "Cycling event prep: inspect chain lubrication, charge headlamp, pin race number, pre-mix electrolyte bottles, pack repair kit, and confirm route download."},
        {"note": "Nonprofit board meeting prep: circulate agenda draft, update financial dashboard, compile committee reports, confirm quorum, and set up video conferencing room."},
        {"note": "Interior painting checklist: patch wall dents, sand trim, wipe surfaces with TSP, tape edges, lay drop cloths, and label paint trays."},
        {"note": "Parent-teacher conference prep: review student portfolios, summarize progress notes, prepare goal suggestions, print attendance schedule, and arrange translation services."},
        {"note": "Wedding photography kit: calibrate lenses, pack spare camera bodies, charge flash batteries, print shot list, sync timeline with planner, and prep rain covers."},
        {"note": "Tenant turnover checklist: collect keys, document meter readings, schedule professional cleaning, patch nail holes, touch up paint, and update listing photos."},
        {"note": "Grant submission timeline: finalize narrative draft, collect letters of support, confirm budget revisions, secure approval signatures, and upload to portal before deadline."},
        {"note": "Weekly meal planning: inventory pantry staples, choose five dinners, prep grocery delivery list, batch cook grains, chop vegetables, and portion snacks."},
        {"note": "Class field trip preparation: confirm bus roster, print permission slips, prepare emergency kits, assign chaperone groups, brief students on expectations, and pack lunches."},
        {"note": "Monthly analytics review: export website traffic report, compare conversion funnels, document notable campaigns, compile stakeholder summary, and set testing hypotheses."},
        {"note": "Tenant safety inspection: test carbon monoxide detector, review fire extinguisher pressure, inspect stair railings, confirm window egress, and log compliance certificates."},
        {"note": "Festival volunteer coordination: update shift spreadsheet, confirm radio check-in times, stock hydration station, brief security protocols, and distribute wristbands."},
        {"note": "Creative sprint kickoff: outline deliverables, assign brainstorming prompts, set inspiration mood board, block calendar time, and prep feedback session plan."},
        {"note": "Kitchen deep-clean checklist: empty fridge shelves, soak stove grates, degrease backsplash, sanitize cutting boards, descale kettle, and polish stainless appliances."},
        {"note": "Home emergency drill prep: map evacuation routes, stage go-bags near exit, test family text alerts, review meet-up spot, and practice utility shutoff."},
        {"note": "Study abroad departure tasks: apply for international phone plan, scan passport copies, notify bank of travel dates, arrange airport drop-off, and pack host family gifts."},
        {"note": "Quarterly compliance audit: refresh policy binder, verify training completion logs, test access controls, document remediation plans, and schedule follow-up review."},
        {"note": "Nonprofit newsletter production: collect success stories, confirm donor spotlight quote, update impact metrics, proofread copy, schedule email send, and prep social teaser."},
        {"note": "Family reunion planning: survey relatives for dates, reserve pavilion permit, arrange catering quote, design invitation, coordinate group photo, and assign welcome table host."},
        {"note": "Teacher professional development day: register for sessions, print workshop tickets, prepare reflection journal, pack laptop charger, and plan classroom coverage."},
        {"note": "Home theater calibration: update firmware, rerun room correction, label HDMI inputs, tidy cable runs, dust projector lens, and test surround mix reference scenes."},
        {"note": "Lab safety inspection checklist: verify chemical labels, test eyewash stations, inventory PPE supplies, update spill response chart, and file compliance report."},
        {"note": "Winter storm prep: wrap outdoor faucets, restock rock salt, test generator, charge lanterns, stage blankets in living room, and confirm neighbor check-in plan."},
        {"note": "App launch readiness: freeze feature branch, update release notes, notify beta testers, schedule app store submission, verify rollback plan, and monitor analytics dashboard."},
        {"note": "After-school club kickoff: renew facility reservation, print membership forms, restock craft supplies, outline first meeting agenda, and message parents with reminders."},
        {"note": "Freelance invoicing routine: log billable hours, generate invoice PDF, email client with polite reminder, update accounting spreadsheet, and set follow-up date."},
    ...
    "TECHNICAL_REFERENCE": [
        ...
        {"note": "Design spec excerpt: mobile onboarding flow must surface biometric opt-in after account creation, referencing Page 12 of accessibility audit."},
        {"note": "Quote from customer interview: \"We chose Plan B because it bundled analytics and support, even though it costs $20 more per month.\""},
        {"note": "Price comparison summary: Model X laptop offers 32GB RAM at $1,799 while Model Y includes OLED display for $1,950; both ship with two-year warranty."},
        {"note": "Policy reference: CDC isolation guidance updated August 2023 recommends five days isolation followed by mask use through day ten when symptoms improve."},
        {"note": "Instruction excerpt: To reset smart thermostat, hold main button for 10 seconds until LED pulses amber, then rejoin Wi-Fi using installer PIN 4726."},
        {"note": "Conference notes: Keynote highlighted Gartner research showing 68% of retailers prioritize curbside pickup investments through 2025."},
